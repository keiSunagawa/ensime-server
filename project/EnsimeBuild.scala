  ...
  lazy val root = Project(id = "ensime", base = file(".")) settings (commonSettings) aggregate (
    ...
    assemblyMergeStrategy in assembly := {
      ...
      case PathList("META-INF", "io.netty.versions.properties") =>
        MergeStrategy.concat // assumes our classpath is setup correctly
      case PathList("LICENSE") =>
        MergeStrategy.concat // WORKAROUND https://github.com/sbt/sbt-assembly/issues/224
      case PathList("LICENSE.apache2") =>
        MergeStrategy.first // WORKAROUND https://github.com/sbt/sbt-assembly/issues/224
...
object EnsimeTestingBuild {
  private def testingProject(dir: String) =
    Project(dir.replace("/", "_"), file(dir)).settings(
