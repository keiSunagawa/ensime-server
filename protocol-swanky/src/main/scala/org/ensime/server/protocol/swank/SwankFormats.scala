...
final case class SwankRPCFormatException(msg: String,
                                         callId: Int,
...
object SwankProtocolCommon {
  ...
  private[swank] def symbolToSourceSymbol(
    stringRep: String
  ): Option[SourceSymbol] = sourceSymbolMap.get(stringRep)
  ...
  implicit val DebugArrayElementHint: TypeHint[DebugArrayElement] =
    TypeHint[DebugArrayElement](SexpSymbol("element"))
  implicit val DebugObjectFieldHint: TypeHint[DebugObjectField] =
    TypeHint[DebugObjectField](SexpSymbol("field"))
  implicit val DebugStackSlotHint: TypeHint[DebugStackSlot] =
    TypeHint[DebugStackSlot](SexpSymbol("slot"))
...
object SwankProtocolResponse {
  ...
  implicit val DebugPrimitiveHint: TypeHint[DebugPrimitiveValue] =
    TypeHint[DebugPrimitiveValue](SexpSymbol("prim"))
  implicit val DebugObjectHint: TypeHint[DebugObjectInstance] =
    TypeHint[DebugObjectInstance](SexpSymbol("obj"))
  implicit val DebugArrayHint: TypeHint[DebugArrayInstance] =
    TypeHint[DebugArrayInstance](SexpSymbol("arr"))
  implicit val DebugStringHint: TypeHint[DebugStringInstance] =
    TypeHint[DebugStringInstance](SexpSymbol("str"))
  implicit val DebugNullHint: TypeHint[DebugNullValue] =
    TypeHint[DebugNullValue](SexpSymbol("null"))
  implicit val NoteErrorHint: TypeHint[NoteError.type] =
    TypeHint[NoteError.type](SexpSymbol("error"))
  implicit val NoteWarnHint: TypeHint[NoteWarn.type] =
    TypeHint[NoteWarn.type](SexpSymbol("warn"))
  implicit val NoteInfoHint: TypeHint[NoteInfo.type] =
    TypeHint[NoteInfo.type](SexpSymbol("info"))
  implicit val DebugStepHint: TypeHint[DebugStepEvent] =
    TypeHint[DebugStepEvent](SexpSymbol("step"))
  implicit val DebugBreakHint: TypeHint[DebugBreakEvent] =
    TypeHint[DebugBreakEvent](SexpSymbol("breakpoint"))
  implicit val DebugVMStartHint: TypeHint[DebugVmStartEvent.type] =
    TypeHint[DebugVmStartEvent.type](SexpSymbol("start"))
  implicit val DebugVMDisconnectHint: TypeHint[DebugVmDisconnectEvent.type] =
    TypeHint[DebugVmDisconnectEvent.type](SexpSymbol("disconnect"))
  implicit val DebugExceptionHint: TypeHint[DebugExceptionEvent] =
    TypeHint[DebugExceptionEvent](SexpSymbol("exception"))
  implicit val DebugThreadStartHint: TypeHint[DebugThreadStartEvent] =
    TypeHint[DebugThreadStartEvent](SexpSymbol("threadStart"))
  implicit val DebugThreadDeathHint: TypeHint[DebugThreadDeathEvent] =
    TypeHint[DebugThreadDeathEvent](SexpSymbol("threadDeath"))
  implicit val DebugOutputHint: TypeHint[DebugOutputEvent] =
    TypeHint[DebugOutputEvent](SexpSymbol("output"))
  ...
  implicit val CompilerRestartedHint: TypeHint[CompilerRestartedEvent.type] =
    TypeHint[CompilerRestartedEvent.type](SexpSymbol(":compiler-restarted"))
  ...
  implicit val ClearAllScalaNotesHint: TypeHint[ClearAllScalaNotesEvent.type] =
    TypeHint[ClearAllScalaNotesEvent.type](SexpSymbol(":clear-all-scala-notes"))
  ...
  implicit val ClearAllJavaNotesHint: TypeHint[ClearAllJavaNotesEvent.type] =
    TypeHint[ClearAllJavaNotesEvent.type](SexpSymbol(":clear-all-java-notes"))
  implicit val SendBackgroundMessageHint: TypeHint[SendBackgroundMessageEvent] =
    TypeHint[SendBackgroundMessageEvent](SexpSymbol(":background-message"))
  implicit val DebugHint: TypeHint[DebugEvent] =
    TypeHint[DebugEvent](SexpSymbol(":debug-event"))
  implicit val NamedTypeMemberHint: TypeHint[NamedTypeMemberInfo] =
    TypeHint[NamedTypeMemberInfo](SexpSymbol("named"))
  implicit val PackageHint: TypeHint[PackageInfo] =
    TypeHint[PackageInfo](SexpSymbol("package"))
  implicit val TypeInfoHint: TypeHint[TypeInfo] =
    TypeHint[TypeInfo](SexpSymbol("type"))
  implicit val ArrowTypeHint: TypeHint[ArrowTypeInfo] =
    TypeHint[ArrowTypeInfo](SexpSymbol("t"))
  implicit val BasicTypeHint: TypeHint[BasicTypeInfo] = TypeHint[BasicTypeInfo](
    SexpSymbol("nil")
  ...
  implicit val DebugVmErrorHint: TypeHint[DebugVmError] =
    TypeHint[DebugVmError](SexpSymbol("error"))
  implicit val MethodSearchResultHint: TypeHint[MethodSearchResult] =
    TypeHint[MethodSearchResult](SexpSymbol("method"))
  implicit val TypeSearchResultHint: TypeHint[TypeSearchResult] =
    TypeHint[TypeSearchResult](SexpSymbol("type"))

  implicit val EmptySourcePositionHint: TypeHint[EmptySourcePosition] =
    TypeHint[EmptySourcePosition](SexpSymbol("empty"))
  implicit val LineSourcePositionHint: TypeHint[LineSourcePosition] =
    TypeHint[LineSourcePosition](SexpSymbol("line"))
  implicit val OffsetSourcePositionHint: TypeHint[OffsetSourcePosition] =
    TypeHint[OffsetSourcePosition](SexpSymbol("offset"))
  implicit val TextEditHint: TypeHint[TextEdit] =
    TypeHint[TextEdit](SexpSymbol("edit"))
  implicit val DeleteFileHint: TypeHint[DeleteFile] =
    TypeHint[DeleteFile](SexpSymbol("delete"))
  implicit val NewFileHint: TypeHint[NewFile] =
    TypeHint[NewFile](SexpSymbol("new"))
  ...
  implicit val SendBackgroundMessageEventFormat
    : SexpFormat[SendBackgroundMessageEvent]                    = cachedImplicit
  ...
  implicit object DebugEventFormat extends TraitFormatAlt[DebugEvent] {
    ...
    def read(hint: SexpSymbol, value: Sexp): DebugEvent = hint match {
      ...
      case s if s == DebugExceptionHint.hint =>
        value.convertTo[DebugExceptionEvent]
      case s if s == DebugThreadStartHint.hint =>
        value.convertTo[DebugThreadStartEvent]
      case s if s == DebugThreadDeathHint.hint =>
  ...
  implicit object EnsimeEventFormat extends TraitFormat[EnsimeEvent] {
    ...
    def read(hint: SexpSymbol, value: Sexp): EnsimeEvent = hint match {
      ...
      case s if s == NewScalaNotesHint.hint =>
        value.convertTo[NewScalaNotesEvent]
  ...
  implicit def PackageInfoFormat: SexpFormat[PackageInfo] = {
    def PackageInfoFormat = ???; implicitly[SexpFormat[PackageInfo]]
  }
  implicit def ParamSectionInfoFormat: SexpFormat[ParamSectionInfo] = {
    def ParamSectionInfoFormat = ???; implicitly[SexpFormat[ParamSectionInfo]]
  }
  implicit def ArrowTypeInfoFormat: SexpFormat[ArrowTypeInfo] = {
    def ArrowTypeInfoFormat = ???; implicitly[SexpFormat[ArrowTypeInfo]]
  }
  implicit def BasicTypeInfoFormat: SexpFormat[BasicTypeInfo] = {
    def BasicTypeInfoFormat = ???; implicitly[SexpFormat[BasicTypeInfo]]
  }
  implicit def SymbolInfoFormat: SexpFormat[SymbolInfo] = {
    def SymbolInfoFormat = ???; implicitly[SexpFormat[SymbolInfo]]
  }
  implicit def InterfaceInfoFormat: SexpFormat[InterfaceInfo] = {
    def InterfaceInfoFormat = ???; implicitly[SexpFormat[InterfaceInfo]]
  }
  implicit def ClassInfoFormat: SexpFormat[ClassInfo] = {
    def ClassInfoFormat = ???; implicitly[SexpFormat[ClassInfo]]
  }
  ...
  implicit def StructureViewFormat: SexpFormat[StructureView] = {
    def StructureViewFormat = ???; implicitly[SexpFormat[StructureView]]
  }
  ...
  object RpcResponseEnvelopeFormat extends SexpFormat[RpcResponseEnvelope] {
    ...
    def write(o: RpcResponseEnvelope): Sexp = o match {
      ...
      case _ =>
        throw new IllegalArgumentException(
          s"Illegal combination of callId and payload content: $o"
        )
    }
  }
...
object SwankProtocolRequest {
  ...
  implicit val RemoveFileReqHint: TypeHint[RemoveFileReq] =
    TypeHint[RemoveFileReq](SexpSymbol("swank:remove-file"))
  implicit val UnloadFilesReqHint: TypeHint[UnloadFilesReq] =
    TypeHint[UnloadFilesReq](SexpSymbol("swank:unload-files"))
  implicit val RestartScalaCompilerReqHint: TypeHint[RestartScalaCompilerReq] =
    TypeHint[RestartScalaCompilerReq](
      SexpSymbol("swank:restart-scala-compiler")
    )
  implicit val UnloadFileReqHint: TypeHint[UnloadFileReq] =
    TypeHint[UnloadFileReq](SexpSymbol("swank:unload-file"))
  implicit val TypecheckFileReqHint: TypeHint[TypecheckFileReq] =
    TypeHint[TypecheckFileReq](SexpSymbol("swank:typecheck-file"))
  implicit val TypecheckFilesReqHint: TypeHint[TypecheckFilesReq] =
    TypeHint[TypecheckFilesReq](SexpSymbol("swank:typecheck-files"))
  implicit val UnloadAllReqHint: TypeHint[UnloadAllReq.type] =
    TypeHint[UnloadAllReq.type](SexpSymbol("swank:unload-all"))
  implicit val PublicSymbolSearchReqHint: TypeHint[PublicSymbolSearchReq] =
    TypeHint[PublicSymbolSearchReq](SexpSymbol("swank:public-symbol-search"))
  implicit val ImportSuggestionsReqHint: TypeHint[ImportSuggestionsReq] =
    TypeHint[ImportSuggestionsReq](SexpSymbol("swank:import-suggestions"))
  implicit val DocUriAtPointReqHint: TypeHint[DocUriAtPointReq] =
    TypeHint[DocUriAtPointReq](SexpSymbol("swank:doc-uri-at-point"))
  ...
  implicit val HierarchyOfTypeAtPointReqHint
    : TypeHint[HierarchyOfTypeAtPointReq] = TypeHint[HierarchyOfTypeAtPointReq](
    SexpSymbol("swank:hierarchy-of-type-at-point")
  )
  implicit val TypeAtPointReqHint: TypeHint[TypeAtPointReq] =
    TypeHint[TypeAtPointReq](SexpSymbol("swank:type-at-point"))
  implicit val SymbolAtPointReqHint: TypeHint[SymbolAtPointReq] =
    TypeHint[SymbolAtPointReq](SexpSymbol("swank:symbol-at-point"))
  implicit val RefactorReqHint: TypeHint[RefactorReq] =
    TypeHint[RefactorReq](SexpSymbol("swank:diff-refactor"))
  implicit val SymbolDesignationsReqHint: TypeHint[SymbolDesignationsReq] =
    TypeHint[SymbolDesignationsReq](SexpSymbol("swank:symbol-designations"))
  implicit val ImplicitInfoReqHint: TypeHint[ImplicitInfoReq] =
    TypeHint[ImplicitInfoReq](SexpSymbol("swank:implicit-info"))
  implicit val ExpandSelectionReqHint: TypeHint[ExpandSelectionReq] =
    TypeHint[ExpandSelectionReq](SexpSymbol("swank:expand-selection"))
  implicit val StructureViewReqHint: TypeHint[StructureViewReq] =
    TypeHint[StructureViewReq](SexpSymbol("swank:structure-view"))
  implicit val DebugActiveVmReqHint: TypeHint[DebugActiveVmReq.type] =
    TypeHint[DebugActiveVmReq.type](SexpSymbol("swank:debug-active-vm"))
  implicit val DebugAttachReqHint: TypeHint[DebugAttachReq] =
    TypeHint[DebugAttachReq](SexpSymbol("swank:debug-attach"))
  implicit val DebugStopReqHint: TypeHint[DebugStopReq.type] =
    TypeHint[DebugStopReq.type](SexpSymbol("swank:debug-stop"))
  implicit val DebugSetBreakReqHint: TypeHint[DebugSetBreakReq] =
    TypeHint[DebugSetBreakReq](SexpSymbol("swank:debug-set-break"))
  ...
  implicit val DebugContinueReqHint: TypeHint[DebugContinueReq] =
    TypeHint[DebugContinueReq](SexpSymbol("swank:debug-continue"))
  implicit val DebugStepReqHint: TypeHint[DebugStepReq] =
    TypeHint[DebugStepReq](SexpSymbol("swank:debug-step"))
  implicit val DebugNextReqHint: TypeHint[DebugNextReq] =
    TypeHint[DebugNextReq](SexpSymbol("swank:debug-next"))
  implicit val DebugStepOutReqHint: TypeHint[DebugStepOutReq] =
    TypeHint[DebugStepOutReq](SexpSymbol("swank:debug-step-out"))
  implicit val DebugLocateNameReqHint: TypeHint[DebugLocateNameReq] =
    TypeHint[DebugLocateNameReq](SexpSymbol("swank:debug-locate-name"))
  implicit val DebugValueReqHint: TypeHint[DebugValueReq] =
    TypeHint[DebugValueReq](SexpSymbol("swank:debug-value"))
  implicit val DebugToStringReqHint: TypeHint[DebugToStringReq] =
    TypeHint[DebugToStringReq](SexpSymbol("swank:debug-to-string"))
  implicit val DebugSetValueReqHint: TypeHint[DebugSetValueReq] =
    TypeHint[DebugSetValueReq](SexpSymbol("swank:debug-set-value"))
  implicit val DebugBacktraceReqHint: TypeHint[DebugBacktraceReq] =
    TypeHint[DebugBacktraceReq](SexpSymbol("swank:debug-backtrace"))
  ...
  implicit object PatchOpFormat extends SexpFormat[PatchOp] {
    ...
    def read(sexp: Sexp): PatchOp = sexp match {
      ...
      case SexpList(
          SexpString("*") :: SexpNumber(i) :: SexpNumber(j) :: SexpString(text) :: Nil
          ) =>
  ...
  implicit object RefactorDescFormat extends SexpFormat[RefactorDesc] {
    ...
    def read(sexp: Sexp): RefactorDesc = sexp match {
      case SexpList(params) =>
        val isExpandMatchCases = params
          .grouped(2)
          .collect {
            case List(t @ SexpSymbol("tpe"),
                      s @ SexpString("expandMatchCases")) =>
              (t, s)
          }
          .nonEmpty
        ...
        params
          ...
          case List(
              ...
              (Loc.File, SexpString(f)),
              (Loc.Start, SexpNumber(start))
              ) if isExpandMatchCases =>
            ExpandMatchCasesDesc(File(f).canon, start.intValue, end.intValue)
  ...
  implicit def RemoveFileReqFormat: SexpFormat[RemoveFileReq] = {
    def RemoveFileReqFormat = ???; implicitly[SexpFormat[RemoveFileReq]]
  }
  implicit def UnloadFileReqFormat: SexpFormat[UnloadFileReq] = {
    def UnloadFileReqFormat = ???; implicitly[SexpFormat[UnloadFileReq]]
  }
  implicit def UnloadFilesReqFormat: SexpFormat[UnloadFilesReq] = {
    def UnloadFilesReqFormat = ???; implicitly[SexpFormat[UnloadFilesReq]]
  }
  implicit def TypecheckFileReqFormat: SexpFormat[TypecheckFileReq] = {
    def TypecheckFileReqFormat = ???; implicitly[SexpFormat[TypecheckFileReq]]
  }
  implicit def TypecheckFilesReqFormat: SexpFormat[TypecheckFilesReq] = {
    def TypecheckFilesReqFormat = ???; implicitly[SexpFormat[TypecheckFilesReq]]
  }
  implicit def PublicSymbolSearchHint: SexpFormat[PublicSymbolSearchReq] = {
    def PublicSymbolSearchHint = ???;
    implicitly[SexpFormat[PublicSymbolSearchReq]]
  }
  implicit def ImportSuggestionsReqFormat: SexpFormat[ImportSuggestionsReq] = {
    def ImportSuggestionsReqFormat = ???;
    implicitly[SexpFormat[ImportSuggestionsReq]]
  }
  implicit def DocUriAtPointReqFormat: SexpFormat[DocUriAtPointReq] = {
    def DocUriAtPointReqFormat = ???; implicitly[SexpFormat[DocUriAtPointReq]]
  }
  implicit def CompletionsReqFormat: SexpFormat[CompletionsReq] = {
    def CompletionsReqFormat = ???; implicitly[SexpFormat[CompletionsReq]]
  }
  implicit def UsesOfSymbolAtPointReqFormat
    : SexpFormat[UsesOfSymbolAtPointReq] = {
    def UsesOfSymbolAtPointReqFormat = ???;
    implicitly[SexpFormat[UsesOfSymbolAtPointReq]]
  }
  implicit def HierarchyOfTypeAtPointReqFormat
    : SexpFormat[HierarchyOfTypeAtPointReq] = {
    def HierarchyOfTypeAtPointReqFormat = ???;
    implicitly[SexpFormat[HierarchyOfTypeAtPointReq]]
  }
  implicit def TypeAtPointReqFormat: SexpFormat[TypeAtPointReq] = {
    def TypeAtPointReqFormat = ???; implicitly[SexpFormat[TypeAtPointReq]]
  }
  implicit def SymbolAtPointReqFormat: SexpFormat[SymbolAtPointReq] = {
    def SymbolAtPointReqFormat = ???; implicitly[SexpFormat[SymbolAtPointReq]]
  }
  implicit def RefactorReqFormat: SexpFormat[RefactorReq] = {
    def RefactorReqFormat = ???; implicitly[SexpFormat[RefactorReq]]
  }
  implicit def SymbolDesignationsReqFormat
    : SexpFormat[SymbolDesignationsReq] = {
    def SymbolDesignationsReqFormat = ???;
    implicitly[SexpFormat[SymbolDesignationsReq]]
  }
  implicit def ImplicitInfoReqFormat: SexpFormat[ImplicitInfoReq] = {
    def ImplicitInfoReqFormat = ???; implicitly[SexpFormat[ImplicitInfoReq]]
  }
  implicit def ExpandSelectionReqFormat: SexpFormat[ExpandSelectionReq] = {
    def ExpandSelectionReqFormat = ???;
    implicitly[SexpFormat[ExpandSelectionReq]]
  }
  implicit def StructureViewReqFormat: SexpFormat[StructureViewReq] = {
    def StructureViewReqFormat = ???; implicitly[SexpFormat[StructureViewReq]]
  }
  implicit def DebugAttachReqFormat: SexpFormat[DebugAttachReq] = {
    def DebugAttachReqFormat = ???; implicitly[SexpFormat[DebugAttachReq]]
  }
  implicit def DebugSetBreakReqFormat: SexpFormat[DebugSetBreakReq] = {
    def DebugSetBreakReqFormat = ???; implicitly[SexpFormat[DebugSetBreakReq]]
  }
  implicit def DebugClearBreakReqFormat: SexpFormat[DebugClearBreakReq] = {
    def DebugClearBreakReqFormat = ???;
    implicitly[SexpFormat[DebugClearBreakReq]]
  }
  implicit def DebugContinueReqFormat: SexpFormat[DebugContinueReq] = {
    def DebugContinueReqFormat = ???; implicitly[SexpFormat[DebugContinueReq]]
  }
  implicit def DebugStepReqFormat: SexpFormat[DebugStepReq] = {
    def DebugStepReqFormat = ???; implicitly[SexpFormat[DebugStepReq]]
  }
  implicit def DebugNextReqFormat: SexpFormat[DebugNextReq] = {
    def DebugNextReqFormat = ???; implicitly[SexpFormat[DebugNextReq]]
  }
  implicit def DebugStepOutReqFormat: SexpFormat[DebugStepOutReq] = {
    def DebugStepOutReqFormat = ???; implicitly[SexpFormat[DebugStepOutReq]]
  }
  implicit def DebugLocateNameReqFormat: SexpFormat[DebugLocateNameReq] = {
    def DebugLocateNameReqFormat = ???;
    implicitly[SexpFormat[DebugLocateNameReq]]
  }
  implicit def DebugValueReqFormat: SexpFormat[DebugValueReq] = {
    def DebugValueReqFormat = ???; implicitly[SexpFormat[DebugValueReq]]
  }
  implicit def DebugToStringReqFormat: SexpFormat[DebugToStringReq] = {
    def DebugToStringReqFormat = ???; implicitly[SexpFormat[DebugToStringReq]]
  }
  implicit def DebugSetValueueReqFormat: SexpFormat[DebugSetValueReq] = {
    def DebugSetValueueReqFormat = ???; implicitly[SexpFormat[DebugSetValueReq]]
  }
  implicit def DebugBacktraceReqFormat: SexpFormat[DebugBacktraceReq] = {
    def DebugBacktraceReqFormat = ???; implicitly[SexpFormat[DebugBacktraceReq]]
  }
    ...
    override def read(sexp: Sexp): RpcRequest = sexp match {
      case SexpList((kind: SexpSymbol) :: rest) =>
        ...
        kind match {
          ...
          case s if s == RestartScalaCompilerReqHint.hint =>
            value.convertTo[RestartScalaCompilerReq]
          case s if s == UnloadFilesReqHint.hint =>
            value.convertTo[UnloadFilesReq]
          case s if s == UnloadFileReqHint.hint =>
            value.convertTo[UnloadFileReq]
          case s if s == TypecheckFileReqHint.hint =>
            value.convertTo[TypecheckFileReq]
          case s if s == TypecheckFilesReqHint.hint =>
            value.convertTo[TypecheckFilesReq]
          case s if s == UnloadAllReqHint.hint => UnloadAllReq
          case s if s == PublicSymbolSearchReqHint.hint =>
            value.convertTo[PublicSymbolSearchReq]
          case s if s == ImportSuggestionsReqHint.hint =>
            value.convertTo[ImportSuggestionsReq]
          case s if s == DocUriAtPointReqHint.hint =>
            value.convertTo[DocUriAtPointReq]
          case s if s == CompletionsReqHint.hint =>
            value.convertTo[CompletionsReq]
          case s if s == UsesOfSymbolAtPointReqHint.hint =>
            value.convertTo[UsesOfSymbolAtPointReq]
          case s if s == HierarchyOfTypeAtPointReqHint.hint =>
            value.convertTo[HierarchyOfTypeAtPointReq]
          case s if s == TypeAtPointReqHint.hint =>
            value.convertTo[TypeAtPointReq]
          case s if s == SymbolAtPointReqHint.hint =>
            value.convertTo[SymbolAtPointReq]
          case s if s == RefactorReqHint.hint => value.convertTo[RefactorReq]
          case s if s == SymbolDesignationsReqHint.hint =>
            value.convertTo[SymbolDesignationsReq]
          case s if s == ImplicitInfoReqHint.hint =>
            value.convertTo[ImplicitInfoReq]
          case s if s == ExpandSelectionReqHint.hint =>
            value.convertTo[ExpandSelectionReq]
          case s if s == StructureViewReqHint.hint =>
            value.convertTo[StructureViewReq]
          case s if s == DebugActiveVmReqHint.hint => DebugActiveVmReq
          case s if s == DebugAttachReqHint.hint =>
            value.convertTo[DebugAttachReq]
          case s if s == DebugStopReqHint.hint => DebugStopReq
          case s if s == DebugSetBreakReqHint.hint =>
            value.convertTo[DebugSetBreakReq]
          case s if s == DebugClearBreakReqHint.hint =>
            value.convertTo[DebugClearBreakReq]
          case s if s == DebugClearAllBreaksReqHint.hint =>
            DebugClearAllBreaksReq
          case s if s == DebugListBreakpointsReqHint.hint =>
            DebugListBreakpointsReq
          case s if s == DebugRunReqHint.hint => DebugRunReq
          case s if s == DebugContinueReqHint.hint =>
            value.convertTo[DebugContinueReq]
          ...
          case s if s == DebugStepOutReqHint.hint =>
            value.convertTo[DebugStepOutReq]
          case s if s == DebugLocateNameReqHint.hint =>
            value.convertTo[DebugLocateNameReq]
          case s if s == DebugValueReqHint.hint =>
            value.convertTo[DebugValueReq]
          case s if s == DebugToStringReqHint.hint =>
            value.convertTo[DebugToStringReq]
          case s if s == DebugSetValueReqHint.hint =>
            value.convertTo[DebugSetValueReq]
          case s if s == DebugBacktraceReqHint.hint =>
